...
ActiveRecord::Schema.define(version: 2023_08_26_073527) do
  ...
  create_table "footprints", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
  ...
  create_table "illustrations", charset: "utf8mb4", collation: "utf8mb4_bin", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "position"
    t.bigint "work_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["work_id", "created_at"], name: "index_illustrations_on_work_id_and_created_at"
